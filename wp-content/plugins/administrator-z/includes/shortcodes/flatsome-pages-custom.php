...
$___->shortcode_name     = 'adminz_ux_pages';
$___->shortcode_title    = 'Pages custom';
...
$___->shortcode_scripts  = array( 'flatsome-masonry-js' => get_template_directory_uri() . '/assets/libs/packery.pkgd.min.js', );
	...
	foreach ( $childpages as $page ) {
		...
		<div class="<?php echo esc_attr( implode( ' ', $classes_col ) ); ?>" <?php echo esc_attr( $animate ); ?>>
			<div class="col-inner" <?php echo get_shortcode_inline_css( $css_col ); ?>>
				...
				<a class="plain" href="<?php echo get_the_permalink( $page->ID ); ?>"
					title="<?php echo esc_attr( $page->post_title ); ?>" target="<?php echo esc_attr( $target ); ?>">
					<div class="<?php echo esc_attr( implode( ' ', $classes_box ) ); ?>">
						...
						<div class="<?php echo esc_attr( implode( ' ', $classes_text ) ); ?>" <?php echo get_shortcode_inline_css( $css_args ); ?>>
							<div class="box-text-inner">
								<<?php echo esc_attr( $heading_tag ); ?> class="is-<?php echo esc_attr( $title_size ); ?>
									<?php echo esc_attr( $title_style ); ?>"><?php echo esc_attr( $page->post_title ); ?></<?php echo esc_attr( $heading_tag ); ?>>
							</div>

							<?php if ( $excerpt !== 'false' ) { ?>
								<div class="is-divider"></div>
								<p
									class="from_the_blog_excerpt <?php if ( $show_excerpt !== 'visible' ) {
							...
							<?php } ?>
							<?php if ( $readmore ) { ?>
								<button href="<?php echo get_the_permalink( $page->ID ); ?>"
