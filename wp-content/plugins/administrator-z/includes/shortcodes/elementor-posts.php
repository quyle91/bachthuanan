...
add_action( 'elementor/widgets/widgets_registered', function(){
	class ADMINZ_Posts extends \Elementor\Widget_Base {
		public function get_name() {
			return 'adminz-posts';		
		}
		public function get_title() {
			return __( 'Adminz Posts', 'administrator-z' );
		}
		public function get_icon() {
			return 'eicon-gallery-grid';
		}
		public function get_keywords() {
			return [ ADMINZ_NAME, 'post' ];
		}
	...
	*/
	...
	\Elementor\Plugin::instance()->widgets_manager->register( new ADMINZ_Posts() );
} );