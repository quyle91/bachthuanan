...
// Allow select custom terms of custom taxonomy 
$___                     = new \Adminz\Helper\FlatsomeELement;
$___->shortcode_name     = 'adminz_flatsome_products_new';
$___->shortcode_title    = 'Woo products custom';
$___->shortcode_icon     = 'woo_products';
$___->shortcode_scripts     = array(
...
$___->options            = function() {
	...
	$custom_tax = adminz_tmp( 'adminz_taxonomies_options', adminz_get_taxonomy_options( 'product' ) );
