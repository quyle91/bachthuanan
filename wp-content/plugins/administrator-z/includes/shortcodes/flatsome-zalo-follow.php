...
$___->shortcode_name     = 'adminz_follow';
$___->shortcode_title    = 'Follows custom';
...
$___->shortcode_callback = function ($atts, $content = null) {
	...
	<div class="<?php echo esc_attr(implode(' ', $wrapper_class)); ?>" <?php echo esc_attr($scale);?>>
		...
		<?php if($zalo){?>
			...
			echo adminz_get_icon( 'zalo', [ 'style' => [ 'width' => '1em;', 'margin-bottom' => '-2px', 'fill' => 'currentColor' ] ] );
			?></i>
		</a>
		<?php }?>
		<?php if ( $skype ) { ?>
			<a href="<?php echo esc_attr( $skype ); ?>" target="_blank" data-label="Skype" rel="noopener noreferrer nofollow"
				class="<?php echo esc_attr( $style ); ?> skype tooltip" title="<?php _e( 'Skype', 'administrator-z' ) ?>"
				aria-label="<?php esc_attr_e( 'Skype', 'administrator-z' ); ?>"><i class="icon-"><?php
						echo adminz_get_icon( 'skype', [ 'style' => [ 'width' => '1em;', 'margin-bottom' => '-2px', 'fill' => 'currentColor' ] ] );
						?></i>
			</a>
		<?php } ?>
		<?php if ( $whatsapp ) { ?>
			<a href="<?php echo esc_attr( $whatsapp ); ?>" target="_blank" data-label="Whatsapp" rel="noopener noreferrer nofollow"
				class="<?php echo esc_attr( $style ); ?> whatsapp tooltip" title="<?php _e( 'Whatsapp', 'administrator-z' ) ?>"
				aria-label="<?php esc_attr_e( 'Whatsapp', 'administrator-z' ); ?>"><i class="icon-"><?php
						echo adminz_get_icon( 'whatsapp', [ 'style' => [ 'width' => '1em;', 'margin-bottom' => '-2px', 'fill' => 'currentColor' ] ] );
						?></i>
		<?php } ?>
		<?php if($facebook){?>
